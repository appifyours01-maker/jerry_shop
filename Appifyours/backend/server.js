...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/jerry_shop_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '6a706b47e81f2c2f51b748cf',
...
app.listen(PORT, () => {
  ...
  console.log(`Jerry shop Backend Server running on port ${PORT}`);
